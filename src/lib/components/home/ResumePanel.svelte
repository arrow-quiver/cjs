		...
		<ul class="flex flex-col gap-3.5">
			{#each cards as card (card.id)}
				...
				<li>
					<a
						href={card.href}
						class="flex items-center gap-3.5 rounded-[10px] bg-surface-card px-4 py-3.5 transition-colors outline-none hover:bg-surface-raised focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-focus-ring focus-visible:outline-solid"
					>
