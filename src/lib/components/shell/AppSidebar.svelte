			...
			<div class="flex flex-col gap-0.5">
				...
				{#each group.items as item (item.key)}
					...
					<a
						...
						class="flex h-[38px] items-center gap-2.5 rounded-md px-2.5 text-ui transition-colors outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-focus-ring focus-visible:outline-solid"
	...
	<div class="mt-auto flex flex-col gap-0.5 border-t border-line-subtle pt-3">
		...
		{#each PLATFORM_ITEMS as row (row.href)}
			<a
				...
				class="flex h-[34px] items-center gap-2.5 rounded-md px-2.5 text-ui text-ink-secondary transition-colors outline-none hover:bg-surface-raised focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-focus-ring focus-visible:outline-solid"
			>
		...
		<form method="POST" action="/sign-out">
			<button
				type="submit"
				class="flex h-[34px] w-full items-center gap-2.5 rounded-md px-2.5 text-left text-ui text-ink-secondary transition-colors outline-none hover:bg-surface-raised focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-focus-ring focus-visible:outline-solid"
			>
				Sign out
			</button>
		</form>
