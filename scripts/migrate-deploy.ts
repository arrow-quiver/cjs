 ...
 * somebody remembering to migrate by hand. This script runs first in Vercel's
 * `buildCommand`, so the schema lands in the same act that ships the code that needs it.
 *
